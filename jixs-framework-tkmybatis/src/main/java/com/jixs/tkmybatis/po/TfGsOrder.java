...
@Table(name = "tf_gs_order")
public class TfGsOrder {
    /**
     * 保障单编号
     */
    @Id
     ...
     * 受理员工名称
     */
    @Column(name = "ACCEPT_STAFF_NAME")
    private String acceptStaffName;

    /**
     * 受理渠道
     */
    @Column(name = "ACCEPT_DEPART_ID")
    private String acceptDepartId;

    /**
     * 受理渠道名称
     */
    @Column(name = "ACCEPT_DEPART_NAME")
     ...
     * 是否重大障碍：1、是, 0、否
     */
    @Column(name = "IS_MAJOR_FAULT")
    private Integer isMajorFault;

    /**
     * 是否群障：1、是, 0、否
     */
    @Column(name = "IS_GROUP_FAULT")
    private Integer isGroupFault;

    /**
     * 默认0
     */
    @Column(name = "REPEAT_APPLY_NUM")
    private Integer repeatApplyNum;

    /**
     * 默认0
     */
    @Column(name = "REPEAT_FAULT_NUM")
    private Integer repeatFaultNum;

    /**
     * 重派标识：1、是, 0、否
     */
    @Column(name = "REDISPATCH_FLAG")
     ...
     * 是否预约：1、是, 0、否
     */
    @Column(name = "IS_RESERVAT")
    private Integer isReservat;

    /**
     * 预约时间
     */
    @Column(name = "RESERVAT_TIME")
