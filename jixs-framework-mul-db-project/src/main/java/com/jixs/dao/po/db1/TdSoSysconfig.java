...
@Table(name = "td_so_sysconfig")
public class TdSoSysconfig {
    /**
     * 参数编码
     */
    @Id
     ...
     * @param modStaff 修改员工
     */
    public void setUpdateStaff(String modStaff) {
        this.updateStaff = modStaff;
    }
